...
pdf("figures/Tn5_insertion_histograms.pdf", width = 6, height = 6)
# Mean Tn5 insertion
...
ggsave("figures/Tn5_insertion_mean_boxplots.png", width = 10, height = 5, units = "in")
...
ggsave("figures/Tn5_insertion_median_boxplots.png", width = 10, height = 5, units = "in")
...
ggsave("figures/Tn5_insertion_sd_boxplots.png", width = 10, height = 5, units = "in")
```
...
regression_results_telomeric %>%
  ...
  xlab(NULL) +
  theme_classic()
ggsave("figures/Tn5_insertion_mean_boxplots_2Mb.png", width = 4.8, height = 4, units = "in")
```
...
regression_results_telomeric %>%
  # sample_frac(0.1) %>%
  mutate(abs_effect_size = abs(beta), log10p = -log10(pval)) %>%
  ...
  mutate(
    ...
    significance_measure = case_when(
      significance_measure == "abs_effect_size" ~ "Absolute Effect Size",
  ...
  xlab(NULL) +
  theme_bw()
ggsave("figures/insertion_significance_correlation.png", width = 10, height = 9, units = "in")
```
...
regression_results_telomeric %>%
  ...
  xlab(NULL) +
  theme_bw()
ggsave("figures/fpQTL_insertion_significance_correlation.png", width = 10, height = 9, units = "in")
```
...
regression_results_telomeric %>%
  ...
  geom_point() +
  stat_cor(method = "spearman", label.x.npc = "middle") +
  ylab("Absolute effect size (|beta|)") +
  xlab("Mean local Tn5 insertions") +
  theme_classic()
ggsave("figures/fpQTL_mean_insertion_effect_size_correlation.png", width = 5, height = 5, units = "in")
...
regression_results_telomeric %>%
  ...
  xlab("Mean local Tn5 insertions") +
  theme_classic()
ggsave("figures/fpQTL_mean_insertion_pval_correlation.png", width = 5, height = 5, units = "in")
```
