...
ggsave("figures/mean_peak_cpm_boxplot_fpQTLs.png", width = 8, height = 5, units = "in")
```
2 Mb only
...
fpQTLs_telomeric %>%
  ...
  stat_compare_means() +
  theme_classic()
ggsave("figures/mean_peak_cpm_boxplot_fpQTLs_2Mb.png", width = 5, height = 5, units = "in")
```
...
ggsave("figures/mean_peak_cpm_boxplot_all_vars.png", width = 5, height = 6, units = "in")
```
