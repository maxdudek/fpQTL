...
fpQTL_data <- data.frame(
  ...
  separate(rsID, into = c("rsID", NA), sep = "_") # "rsXXXXXX_2" --> "rsXXXXXX"
```
...
eQTL_fpQTL_joined <- eqtl_all_vars %>%
  select(variant_id, variant_chrom, variant_pos, ref_allele.eQTL, alt_allele.eQTL, slope, eQTL) %>%
...
ggsave("figures/eQTL-fpQTL_direction.png", width = 5, height = 5.1, units = "in", dpi = 300)
...
caQTL_fpQTL_joined %>%
  ...
  theme_classic()+
  theme(legend.position = "top")
ggsave("figures/caQTL-fpQTL_direction.png", width = 5, height = 5.1, units = "in", dpi = 300)
...
ggplot() + 
  ...
  theme_classic()
ggsave("figures/eQTL_QQ.png", width = 5, height = 5, units = "in", dpi = 300)
```
...
ggplot() + 
  ...
  xlab(bquote(Expected ~~ -log[10](p))) +
  theme_classic()
ggsave("figures/caQTL_QQ.png", width = 5, height = 5, units = "in", dpi = 300)
```
