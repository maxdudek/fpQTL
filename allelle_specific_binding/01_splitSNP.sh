...
# Create summary file
echo -e "args.output_prefix\tchrom\tpos\tref\talt\tref_count\talt_count" > splitSNP_summary.txt
...
do
    ...
    out_dir="split_bams/${rs}_$chrom:$pos"
    mkdir -p $out_dir
