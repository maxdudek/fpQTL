...
motif_matches_chip_only %>%
  ...
  # xlim(c(-15.2, 15.1)) +
  ylim(c(-0.32, 0.2)) +
  stat_cor(method = "spearman", label.y = -0.23, label.x = 5, label.x.npc = 0.55) +
  # ylim(c(NA, 0.15)) +
  theme_classic()
...
ggsave(paste0("figures/", MOTIF_THRESHOLD, "/", FP_METHOD,
                "_concordance_bar_plot_cutoff=", COUNT_CUTOFF, "_grouped.png"), width = 5, height = 5, units = "in")
```
